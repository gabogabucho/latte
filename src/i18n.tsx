...
const es = {
  ...
  'decision.authority.label':'Decisiones del agente','decision.authority.off':'Desactivadas','decision.authority.suggest':'Sugerir para aprobar','decision.authority.auto':'Registrar automáticamente','decision.authority.help':'Esto no cambia los permisos de archivos o herramientas. Sólo define qué pasa cuando el agente invoca explícitamente el protocolo de decisión.','decision.add':'Agregar','decision.editAdd':'Editar y agregar','decision.discard':'Descartar','decision.undo':'Deshacer','decision.pending':'Propuesta del agente','decision.autoNotice':'Registrada por el agente','decision.archived':'Archivada',
...
const en: Record<MessageKey, string> = {
  ...
  'decision.authority.label':'Agent decisions','decision.authority.off':'Off','decision.authority.suggest':'Suggest for approval','decision.authority.auto':'Record automatically','decision.authority.help':'This does not change file or tool permissions. It only controls explicit decision-protocol invocations.','decision.add':'Add','decision.editAdd':'Edit and add','decision.discard':'Discard','decision.undo':'Undo','decision.pending':'Agent proposal','decision.autoNotice':'Recorded by agent','decision.archived':'Archived',
