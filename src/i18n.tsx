...
const es = {
  ...
  'continue.help': 'Latte lo arma sin IA con el brief, las decisiones aprobadas, los documentos, la carpeta y los últimos mensajes que el runtime expone. No copia documentos ni la conversación entera: lo que ves es lo que se envía.',
...
const en: Record<MessageKey, string> = {
  ...
  'continue.help': 'Latte builds it without AI from the brief, the approved decisions, the documents, the folder, and the latest messages the runtime exposes. It does not copy documents or the whole conversation: what you see is what is sent.',
