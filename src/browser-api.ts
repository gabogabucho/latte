...
export const browserAPI: LatteAPI = {
  ...
  listUntrackedFiles: async()=>[],listFolderEntries:async()=>({subfolders:[],otherFiles:[],truncated:false}),listSkills:async()=>[],setSkillEnabled:unavailable,applyFunnelProposal:unavailable,dismissFunnelProposal:unavailable,trackFile:unavailable,
