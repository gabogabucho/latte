...
const doc = (patch: Partial<WorkDocument> = {}): WorkDocument => ({ id:'a',workId:'w',kind:'note',title:'Una campaña con nombre completo',fileName:'oferta.md',status:'draft',funnelStages:[],baseDocumentId:null,baseRevisionId:null,baseFingerprint:null,createdAt:'',updatedAt:'',...patch });
